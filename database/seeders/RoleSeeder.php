...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = array(
            ...
            ["name" => "venta.listar", 'guard_name' => 'web', 'description' => 'Listar venta', 'modulo' => 'Inventario'],
            ["name" => "venta.agregar", 'guard_name' => 'web', 'description' => 'Agregar venta', 'modulo' => 'Inventario'],
            ["name" => "venta.eliminar", 'guard_name' => 'web', 'description' => 'Eliminar venta', 'modulo' => 'Inventario'],
