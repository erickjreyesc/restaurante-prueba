<div>
    <div class="offcanvas offcanvas-start" tabindex="-1" id="navoffcanvas" aria-labelledby="navoffcanvasLabel">
        ...
        <div class="offcanvas-body">
            <div class="py-1 text-center d-block d-sm-block d-md-none d-lg-none d-xl-none d-xxl-none bg-indentity">
                ...
                <img class="my-2 rounded-circle" width="50" height="50" src="{{ Auth::user()->profile_photo_url }}"
                    alt="{{ Auth::user()->usuario }}" /> <br>
                @endif
            ...
            <div class="accordion accordion-flush" id="accordionFlushMainMenu">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="flush-headingActas">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <i class="fas fa-file-contract me-1"></i>Reuniones
                        </button>
                    </h2>
                    <div id="flush-collapseActas" class="accordion-collapse collapse"
                        ...
                        <div class="border-0 accordion-body">
                            <ul class="list-group">
                                @can('actas.listar')
                                <a class="no-bullets" href="{{ route('actas.listar') }}">
                                    <li class="list-group-item">
                                        <i class="fas fa-file-import me-1"></i>Actas
                                    </li>
                                </a>
                                @endcan
                            </ul>
                ...
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseParams" class="accordion-collapse collapse"
                        ...
                        <div class="border-0 accordion-body">
                            <ul class="list-group">
                                @can('tipo-reunion.listar')
                                <a class="no-bullets" href="{{ route('tipo-reunion.listar') }}">
                                    <li class="list-group-item">
                                        <i class="fas fa-handshake me-1"></i>Tipo Reunión
                                    </li>
                                </a>
                                @endcan
                                @can('dependencia.listar')
                                <a class="no-bullets" href="{{ route('dependencia.listar') }}">
                                    <li class="list-group-item">
                                        <i class="fas fa-warehouse me-1"></i>Dependencias
                                    </li>
                                </a>
                                @endcan
                            </ul>
                ...
                @canany(['security.usuarios', 'security.logs'])
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseSecurity" class="accordion-collapse collapse"
                        ...
                        <div class="border-0 accordion-body">
                            <ul class="list-group">
                                @can('security.usuarios')
                                <a class="no-bullets" href="{{ route('security.usuarios') }}">
                                    <li class="list-group-item">
                                ...
                                @endcan
                                @can('security.logs')
                                <a class="no-bullets" href="{{ route('security.logs') }}">
                                    <li class="list-group-item">
    ...
    <nav class="navbar navbar-expand-md bg-main navbar-dark border-bottom sticky-top">
        <div class="container">
            <div>
                <!-- Logo -->
                <button class="btn btn-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#navoffcanvas"
                        ...
                        <x-jet-dropdown id="settingsDropdown">
                            <x-slot name="trigger">
                                ...
                                <img class="rounded-circle" width="32" height="32"
                                    src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->usuario }}" />
                                @else
                                {{ Auth::user()->usuario }}
