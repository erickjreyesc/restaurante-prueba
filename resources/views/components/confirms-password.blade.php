@props(['title' => __('frontend.password-confirm'), 'content' => __('frontend.password-modal'), 'button' => __('frontend.confirm')])
...
<x-jet-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-jet-input type="password" class="{{ $errors->has('confirmable_password') ? 'is-invalid' : '' }}" placeholder="{{ __('frontend.password') }}"
